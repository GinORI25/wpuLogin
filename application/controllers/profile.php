...
class Profile extends CI_Controller 
{
    ...
    public function index()
    {
        ...
        if($this->form_validation->run() == false){
            ...
            congrats your proflie has been editing </div>');
            redirect('profile');
        }
    }
    ...
    public function ChangePassword()
    {
        ...
        $this->form_validation->set_rules('new_password2','Confirm New password1','required|trim|min_length[3]|matches[new_password1]');
